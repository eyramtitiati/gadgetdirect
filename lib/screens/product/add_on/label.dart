...
class LabelField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? durationStyle = theme.textTheme.bodyText2?.copyWith(color: style?.color);

    if (type == 'heading') {
      style = theme.textTheme.headline6;
      durationStyle = theme.textTheme.subtitle2?.copyWith(color: style?.color);
    }
...
class DescriptionField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(description, style: theme.textTheme.caption);
  }
}
