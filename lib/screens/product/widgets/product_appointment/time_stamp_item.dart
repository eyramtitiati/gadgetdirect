      ...
      child: SizedBox(
        ...
        child: TextButton(
          ...
          style: TextButton.styleFrom(
            ...
            primary: _isPicked() ? theme.colorScheme.onPrimary : theme.textTheme.subtitle1?.color,
                ...
                Row(
                  ...
                  children: [
                    (getMaxAvailable(
                            ...
                            0)
                        ? Text(
                            "${getMaxAvailable(activeHoursData: widget.activeHoursData, date: widget.dateTime, staffId: widget.staffId)} max")
